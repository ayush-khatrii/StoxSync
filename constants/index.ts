...
export type Ipo={id:string;company:string;symbol:string;initials:string;offerDate:string;offerStart?:string;offerEnd?:string;offerPrice:string;cutOffPrice:number;lotSize:number};
